...
function provideDefaultResources(env, platform) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (yield fs_1.pathExists(destinationDir)) {
            env.log.debug(`${chalk_1.default.bold(prettyPath(destinationDir))} exists, not overwriting directory with default Ionic resources.`);
        }
        else {
            ...
            if (!(yield fs_1.pathAccessible(sourceDir, fs.constants.R_OK))) {
                throw new Error(`Error while reading directory: ${chalk_1.default.bold(sourceDir)} (doesn't exist or isn't accessible)`);
            }
        ...
        if (recreateTmpDir) {
            ...
            const resourcesDirFiles = yield Promise.all((yield fs_1.readDir(tmpResourcesDir)).map((f) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    env.log.warn(`Error while stat-ing ${chalk_1.default.bold(p)}: ${e.stack ? e.stack : e}`);
                }
            })));
